# Проект Foodgram
![example workflow](https://github.com/DmitrTRC/foodgram-project-react/actions/workflows/foodgram_workflow.yml/badge.svg)
...
```shell
git clone https://github.com/DmitrTRC/foodgram-project-react
```
